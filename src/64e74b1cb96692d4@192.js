// https://observablehq.com/@d3/bubble-chart@192
export default function define(runtime, observer) {
  const main = runtime.module();
  const fileAttachments = new Map([["data.csv",new URL("./files/aee5d40e70ea9830c96efe6da03ad32187ff7223ad1b7b84e38c32127ccf6661b576fe0005b42657703e7bfaaefabc74550268cc35f64122a652fc471110c832",import.meta.url)]]);
...
(await FileAttachment("data.csv").csv())
  .filter(({value}) => value !== "")
  .map(({id, value}) => ({name: id.split(".").pop(), title: id.replace(/\./g, "/"), group: id.split(".")[1], value: +value}))
)});
